...
### Comment
The impulse responses of Model 5  are defined under three different terminal conditions used to close the finite-horizon perfect-foresight problem: leaving terminal debt free, forcing debt back to its steady-state value, and pinning terminal marginal utility to its steady-state level.
