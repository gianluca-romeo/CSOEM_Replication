...
1. zero terminal debt drift: $d_T = d_{T-1}$;
2. debt forced back to steady state: $d_T = \bar d$;
3. capital and marginal utility returned to steady state: $k_{T+1}=k^{ss}$, $\lambda_T=\lambda^{ss}$.
